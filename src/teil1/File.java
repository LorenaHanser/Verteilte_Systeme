    ...
    public void create() {
        try {
            ...
            if (!new java.io.File(path).exists()) {
                ...
                if (createdDirectory) {
                    System.out.println(ANSI_WHITE + "Ordner " + DIRECTORY_NAME + " wurde neu erstellt." + ANSI_RESET);
                } else {
                    System.out.println(ANSI_WHITE + "Ordner " + DIRECTORY_NAME + " konnte nicht erstellt werden." + ANSI_RESET);
                }
            } else {
                System.out.println(ANSI_WHITE + "Ordner " + DIRECTORY_NAME + " existiert bereits." + ANSI_RESET);
            }
